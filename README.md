...
Add with `dep ensure -add github.com/Alireza-Ta/termui`. With Dep, `/v3` should *not* be included in the import statements.
...
- [wiki](https://github.com/Alireza-Ta/termui/wiki)
